        ...
        <div class="container">
            <div class="row course-start">
                <div class="col-lg-4 col-12 mb-5">
                    <div class="card">
                        <div class="card-header course-img">
                            <img src="https://www.sanjaywebdesigner.com/articles/wp-content/uploads/2014/09/HTML5-courses.png"
                                alt="HTML PIC" class="card-img-top" height="100%">
                        </div>
                        <div class="card-body">
                            <h1 class="card-title">HTML</h1>
                            <span class="badge rounded-pill bg-dark mb-3">WEB DEVELOPMENT</span> <SPan
                                class="badge rounded-pill bg-danger mb-3">HTML5</SPan>
                            <p class="card-text" style="text-align: justify;">The HyperText Markup Language, or HTML is the standard
                                markup
                            ...
                            <a href="#" style="text-decoration: none;" class="text-white"><button
                                    class="btn btn-outline-primary btn-block">Enroll now<i
                                        class="fas fa-sign-in-alt ms-2"></i></button></a>
                        </div>
                ...
                <div class="col-lg-4 col-12 mb-5">
                    <div class="card">
                        <div class="card-header course-img">
                            <img src="http://www.zccindia.com/wp-content/uploads/2013/10/css3-logo.png" alt="css pic"
                                class="card-img-top" height="100%">
                        </div>
                        <div class="card-body">
                            <h1 class="card-title">CSS</h1>
                            <span class="badge rounded-pill bg-dark mb-3">WEB DEVELOPMENT</span> <SPan
                                class="badge rounded-pill bg-primary mb-3">CSS3</SPan>
                            <p class="card-text" style="text-align: justify;">CSS stands for Cascading Style Sheets · CSS describes how
                                HTML
                                elements are to be displayed on screen, paper, or in other media · CSS saves a lot of
                                work.CSS is the language for describing the presentation of Web pages.It allows one to adapt the presentation to different types of devices.CSS is used for styling the webpage.
                            </p>
                            <a href="#" style="text-decoration: none;" class="text-white"><button
                                    class="btn btn-outline-primary btn-block">Enroll now<i
                                        class="fas fa-sign-in-alt ms-2"></i></button></a>
                ...
                <div class="col-lg-4 col-12 mb-5">
                    <div class="card">
                        <div class="card-header course-img">
                            <img src="https://www.justapplications.co.uk/wp-content/uploads/2019/12/Javascript-shield-1.png"
                                class="card-img-top" height="100%">
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <span class="badge rounded-pill bg-dark mb-3">WEB DEVELOPMENT</span> <SPan
                                class="badge rounded-pill bg-warning mb-3">JAVASCRIPT</SPan>
                            <p class="card-text" style="text-align: justify;">JavaScript (often shortened to JS) is a lightweight,
...
<section class="mt-5 footer">
    ...
    <h3 class="py-5 text-center text-white">Copyright © 2021 Softlogic Systems All Rights Reserved
    </h3>
